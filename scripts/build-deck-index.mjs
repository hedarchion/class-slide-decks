  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      .rule-waves { position: fixed; inset: 0; z-index: 0; overflow: hidden; color: #1f5f9e; font-weight: 800; letter-spacing: -.075em; line-height: .73; opacity: .26; pointer-events: none; user-select: none; }
      ...
      .rule-wave { animation: worm-rule 30s ease-in-out infinite alternate; }
      @keyframes worm-rule {
      ...
      @media (prefers-reduced-motion: reduce) { .rule-wave { animation: none; transform: translate3d(-24vw, 32vh, 0) rotate(-9deg); } }
    </style>
  </head>
  <body>
    <main class="wrap">
